...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // }
        ...
        $sql = "SELECT * FROM admin WHERE email='$email' AND admin_pswd ='$password'";
        // echo $sql;die;
        ...
        if ($num>0) {
            ...
            // $err_msg = "email and password does not match";
            // die($error_password);
            header('location:admin_login.php?invalid_cred=true');
        }
    }
