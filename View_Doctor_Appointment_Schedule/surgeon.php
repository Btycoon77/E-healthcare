            ...
            <div class="overflow-x">
              ...
              >
                ...
                <tbody>
                  ...
                  $query = "SELECT * 
                  FROM doctor inner join schedule on schedule.d_id=doctor.id  where permission='approved' AND specialist like's%'";
                  ...
                  if(mysqli_fetch_assoc($result)>0){
                    ...
                    <tr>
                      ...
                      <td><?php
                       echo  "<a href='appointment_detail.php?s_id={$row['s_id']}'>{$row['f_name']}{$row['l_name']}</a>";
