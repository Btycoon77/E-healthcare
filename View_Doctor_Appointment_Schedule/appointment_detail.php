...
$sid=$_POST['sid'];
	...
	elseif(empty($pid))
       ...
       $d_query="INSERT INTO appointment(booking_date,booking_time,permission,date,pid,sid)     
								...
								$update_msg="Your appoinment has been send successfully!! ";
                // header("location:appoinment_details2.php");
...
<h3>Enter Your ID :<?php  echo   $drow['id']; } ?></h3><br />  

  <b><input type = "number" name="pid"/> </b><br /><br /><br />
 
  <h3> Enter This ID :<?php  echo   $row['s_id']; } ?></h3><br />
  <b><input type = "number" name="sid"/></b> <br /><br /><br />
