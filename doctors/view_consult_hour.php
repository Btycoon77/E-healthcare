...
$show_schedule= "SELECT * 
                 FROM doctor inner join consulting_schedule on consulting_schedule.d_id=doctor.id where email='$d_email'" ;
	
$show_schedule_query=mysqli_query($con,$show_schedule);
...
<ul class="pager text-danger font-weight-bold text-monospace">
  <li class="center "><a href="updating_consulting_hour.php">Updating Conlting Hour</a></li>
</ul></div>
