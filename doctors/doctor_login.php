...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if($email =="" || $password==""){
        ...
        header('location:doctor_login.php?err=true');
    }
    ...
    // }
        ...
        $sql = "SELECT * FROM doctor WHERE email='$email' AND pswd ='$password'";
        // echo $sql;die;
        ...
        if ($num>0) {
            ...
            header('location:doctor_login.php?invalid_cred=true');
        }
    }
            ...
            <div class="form login">
                ...
                <div class="login-signup">
                    <span class="text">Not a member?
                        <a href="doc_registration2.php" class="text signup-link">Register now</a>
                    </span>
                </div>
