...
$select_fl_name_query="select fl_name from doctor where f_name='$fl_name' ";
	$run_fl_name_query=mysqli_query($con,$select_fl_name_query);
	
	if(mysqli_num_rows($run_fl_name_query)>0)
	{
	$check_row= mysqli_fetch_assoc($run_fl_name_query);
	
	$edit_fl_name_query="update doctor set fl_name='$fl_name' where fl_name='$fl_name' ";
	
	
	$edit_run_fl_name_query=mysqli_query($con,$edit_fl_name_query);
	if(isset($edit_run_fl_name_query))
	{
	$update_msg="updated ";
		echo"	<script> alert ('Are You Sure ? You Want To Change Your name')</script> ";
    ...
    <div class="card">
        <div class="info">
            ...
            <form action="#" method="post">
                ...
                <div class="input-box">
                        <span class="details">Previous </span>
                        <input type="text" name="name" placeholder="Please enter name" />
                        <span class="details">New Email</span>
                        <input type="text" name="fl_name" placeholder="Please enter name" />
