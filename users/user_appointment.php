...
?>
<?php
$sql="select * from doctor ,schedule where bookAvail='Available' ; " ;
...
$res1 = mysqli_query($con,"SELECT * FROM doctorschedule  INNER JOIN schedule
...
<h2><a target="_blank" href="view_user_homepage.php">Back</a></h2> </p>
</body>
</html>
