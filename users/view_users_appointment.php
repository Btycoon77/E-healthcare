...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
 ...
 <link rel="stylesheet" href="../helper/font-awesome.min.css">
...
<body class="container display-4">
           <h1 class=" shadow-lg">All The Appointments</h1>
...
$email=$_SESSION['email'];
	...
	$doctor_sid_squery=mysqli_query($con,$doctor_sid_show_squery);
...
<ul class="pager font-weight-bold text-monospace">
  <li class="previous "><a href="view_user_homepage.php">Previous</a></li>
